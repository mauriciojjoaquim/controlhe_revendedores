<x-layout-app page-title="Novo Produto" color-site-bg="{{ $conf['color_site_bg'] }}" bg-color-table="{{ $conf['bg_color_table'] }}" color-table-text="{{ $conf['color_table_text'] }}" color-card-bg="{{ $conf['color_card_bg'] }}" color-card-text="{{ $conf['color_card_text'] }}" bg-color-menu-vert="{{ $conf['bg_color_menu_vertical'] }}" color-menu-vert-text="{{ $conf['color_menu_vertical_text'] }}" bg-color-menu-hor="{{ $conf['bg_color_menu_horisontal'] }}" color-menu-hor-text="{{ $conf['color_menu_horisontal_text'] }}"  text-color-site="{{ $conf['text_color_site'] }}" op-bg-color-site="{{ $conf['bg_color_site'] }}">
    ...
    <div class="w-100 p-3">
        ...
        <form action="{{ route('admin.leadership.products.created-product') }}" method="post" enctype="multipart/form-data">

            @csrf
            <div class="container-fluid">
                <div class="justify-content-center">
                    <div class="border {{ $conf['color-border'] }} p-3">
                        <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1 g-2">
                            ...
                            <div class="col">
                                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2">
                                     ...
                                     <div class="col">
                                        <div class="mb-3">
                                            <label for="code" class="form-label">Cod</label>
                    ...
                    <div class="mt-3">
                        <a href="{{ route('admin.leadership.products.table-product') }}" class="btn btn-outline-warning me-3">Voltar</a>
