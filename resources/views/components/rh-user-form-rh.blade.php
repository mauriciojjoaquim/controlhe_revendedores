<form action="{{ route('colaborators.rh.update-rh-user') }}" method="post">
    ...
    <div class="container-fluid">
                ...
                <div class="mb-3">
                    <div class="d-flex">
                        <div class="flex-grow-1 pe-3">
                            ...
                            <select class="form-select" id="select_department" name="select_department" disabled>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="salary" name="salary" step=".01" placeholder="0,00" value="{{ old('salary', $colaborator->detail->salary) }}" readonly>
                            @error('salary')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="admission_date" name="admission_date" placeholder="YYYY-mm-dd" value="{{ old('admission_date', $colaborator->detail->admission_date) }}" readonly>
        ...
        <input type="hidden" name="tipo" id="tipo" value="rh">
