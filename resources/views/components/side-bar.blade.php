<div class="offcanvas offcanvas-start {{ $menuVert }}" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    ...
    <div class="flex-link-0 p-3 {{ $menuVert }}" style="width: 380px;">
        ...
        <ul class="list-unstyled ps-0">
            ...
            {{-- Colaborators --}}
                ...
                <li class="mb-1">
                    ...
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        ...
                        <li><a href="{{ route('adm.products.table-magazine-update-product') }}" class="link-dark rounded"><i class="fas fa-user-gear me-3"></i>Magazine Update</a></li>
                        <li><a href="{{ route('adm.magazine-numbers.table-magazine-numbers') }}" class="link-dark rounded"><i class="fas fa-user-gear me-3"></i>Ciclo das Revistas</a></li>
                    </ul>
                    </div>
                </li>
            ...
            <li class="mb-1">
                <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#account-collapse" aria-expanded="false">
                    <i class="fa-solid fa-money-bill me-2"></i>Vendedoras
                </button>
                <div class="collapse" id="account-collapse">
                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><a href="{{ route('adm.leaders.leader-seller.table-leader-seller') }}" class="link-dark rounded"><i class="fas fa-user-gear me-3"></i>Vededora</a></li>
                </ul>
                </div>
            </li>
            ...
            <li class="mb-1">
                <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#estoques-collapse" aria-expanded="false">
                    <i class="fa-solid fa-money-bill me-2"></i> Departamentos
                </button>
                <div class="collapse" id="estoques-collapse">
                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><a href="{{ route('adm.Leaders.leader-seller-product.table-leader-seller-product') }}" class="link-dark rounded"><i class="fas fa-user-gear me-3"></i>Revistas Produtos</a></li>
                    <li><a href="{{ route('adm.Leaders.leader-seller-supplier.table-leader-seller-supplier') }}" class="link-dark rounded"><i class="fas fa-user-gear me-3"></i>Fornecedores</a></li>
                    <li><a href="{{ route('adm.Leaders.leader-seller-category.table-leader-seller-category')}}" class="link-dark rounded"><i class="fas fa-user-gear me-3"></i>Categorias</a></li>
                    <li><a href="{{ route('adm.products.table-magazine-update-product') }}" class="link-dark rounded"><i class="fas fa-user-gear me-3"></i>Magazine Update</a></li>
                    <li><a href="{{ route('adm.magazine-numbers.table-magazine-numbers') }}" class="link-dark rounded"><i class="fas fa-user-gear me-3"></i>Ciclo das Revistas</a></li>
                </ul>
                </div>
            ...
            <li class="mb-1">
                <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#settings-collapse" aria-expanded="false">
                    <i class="fa-solid fa-money-bill me-2"></i>Configurações
                </button>
                <div class="collapse" id="settings-collapse">
                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><a href="{{ route('adm.Leaders.leader-seller-setting.table-leader-seller-setting') }}" class="link-dark rounded"><i class="fas fa-user-gear me-3"></i>Configuração</a></li>
                </ul>
                </div>
            </li>
        ...
        {{--  --}}
            @can('vende')
                ...
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#invoice-collapse" aria-expanded="false">
                        <i class="fa-solid fa-users-rectangle me-2"></i>Financeiro
                    </button>
                    <div class="collapse" id="invoice-collapse">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li><a href="{{ route('adm.resellers.reseller-invoice-registration-for-payments.table-reseller-invoice') }}" class="link-dark rounded"><i class="fa-solid fa-address-card me-2"></i>Boletos Bancarios</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="mb-1">
                    ...
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        ...
                        <li><a href="{{ route('adm.magazine-numbers.show-table-magazine-numbers') }}" class="link-dark rounded"><i class="fa-solid fa-money-bill me-2"></i>Ciclo da Revista</a></li>
                    </ul>
                    </div>
                </li>
            ...
            @can('rh')
                ...
                <li class="mb-1">
                    ...
                    <div class="collapse" id="account-collapse">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li><a href="" class="link-dark rounded"><i class="fas fa-user-gear me-3"></i>Company Stock</a></li>
                        <li><a href="" class="link-dark rounded"><i class="fas fa-user-gear me-3"></i>Type Service</a></li>
