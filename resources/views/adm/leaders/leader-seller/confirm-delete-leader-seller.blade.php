    ...
    <div class="w-50 p-3">
        ...
        <div class="text-center">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('adm.leaders.leader-seller.table-leader-seller') }}" class="btn btn-warning px-5">No</a>
            <form action="{{ route('adm.leaders.leader-seller.deleted-leader-seller') }}" method="post" class="px-2">
                @csrf
