<x-layout-customer-app page-title="Vendas" color-site-bg="{{ $conf['color_site_bg'] }}" bg-color-table="{{ $conf['bg_color_table'] }}" color-table-text="{{ $conf['color_table_text'] }}" color-card-bg="{{ $conf['color_card_bg'] }}" color-card-text="{{ $conf['color_card_text'] }}" bg-color-menu-vert="{{ $conf['bg_color_menu_vertical'] }}" color-menu-vert-text="{{ $conf['color_menu_vertical_text'] }}" bg-color-menu-hor="{{ $conf['bg_color_menu_horisontal'] }}" color-menu-hor-text="{{ $conf['color_menu_horisontal_text'] }}"  text-color-site="{{ $conf['text_color_site'] }}" op-bg-color-site="{{ $conf['bg_color_site'] }}">
    ...
    <div class="w-100 p-4">
        ...
        <h3>Venda  
          ...
          Cliente: {{ $client->name }} 
            ...
            @if($addtocarts->count() > 0)
                ...
                <a href="{{ route('customers.customer-dealer.cart-installment-customer-detail', ['id' => $client->id ]) }}" class="btn-cart">
        ...
        <div class="justify-content-center p-2">
            <form action="{{ route('customers.home') }}" method="get">
                @csrf
                    ...
                    <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-5 row-cols-xl-5 row-colsxxl-5">
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-2 col-xl-2 col-xxl-2 mb-3 pl-4">
                            ...
                            <div class="d-flex justify-content-start">
                                ...
                                <div class="mb-2  pt-4">
                                    <a href="{{ route('customers.home', ['client_id' => $client->id]) }}" class="btn btn-sm btn-outline-primary p-2">
                ...
                <div class="col-12 col-xl-12 col-md-12 col-md-12 col-sm-12">
                    <div class="border {{ $conf['color-border'] }} p-2">
                        ...
                        <div class="row row-cols-1 row-cols-sm-1 row-cols-md-3 row-cols-xl-3">
                            ...
                            <div class="col-xl-1 col-md-1 col-md-12 col-sm-12">
                            ...
                            <div class="col-xl-5 col-md-5 col-md-12 col-sm-12">
                                <form action="{{ route('customers.customer-dealer.add-to-cart') }}" method="post">
                                    @csrf
                                    <input type="hidden" name="client_id" value="{{ $client->id }}">
                                    ...
                                    <div class="row row-cols-1 row-cols-sm-1 row-cols-md-3 row-cols-xl-3">
                                        ...
                                        <div class="col-xl-2 col-md-2 col-md-12 col-sm-12 text-center">
                                            <div class="">
                                        ...
                                        <div class="col-xl-6 col-md-6 col-md-12 col-sm-12 align-h">
                                            
                                        <div class="row row-cols-1 row-cols-sm-1 row-cols-md-3 row-cols-xl-3 mt-xl-4">

                                            <div class="col-xl-12 col-md-12 col-md-12 col-sm-12 mb-2">
                                                <button type="submit" class="w-100 btn btn-primary btn-sm" name="adcr" value="true"><i class="fa-solid fa-cart-shopping me-2"></i>Adicionar ao Carinho</button>   
                                            </div>
