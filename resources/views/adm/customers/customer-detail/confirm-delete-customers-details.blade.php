    ...
    <div class="w-100 p-4">
        ...
        <div class="text-center">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('admin.clients.client-detail.table-client-detail') }}" class="btn btn-warning px-5">No</a>
            <form action="{{ route('admin.clients.client-detail.deleted-client-detail') }}" method="post" class="px-2">
                @csrf
