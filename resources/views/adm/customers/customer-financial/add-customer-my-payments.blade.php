<x-layout-customer-app page-title="Envio de Comprovante" color-site-bg="{{ $conf['color_site_bg'] }}" bg-color-table="{{ $conf['bg_color_table'] }}" color-table-text="{{ $conf['color_table_text'] }}" color-card-bg="{{ $conf['color_card_bg'] }}" color-card-text="{{ $conf['color_card_text'] }}" bg-color-menu-vert="{{ $conf['bg_color_menu_vertical'] }}" color-menu-vert-text="{{ $conf['color_menu_vertical_text'] }}" bg-color-menu-hor="{{ $conf['bg_color_menu_horisontal'] }}" color-menu-hor-text="{{ $conf['color_menu_horisontal_text'] }}"  text-color-site="{{ $conf['text_color_site'] }}" op-bg-color-site="{{ $conf['bg_color_site'] }}">
    ...
    <div class="w-100 p-1">
        ...
        <form action="{{ route('customers.customer-financial.fom-rcustomer-send-proof-my-payments') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="container-fluid">
                <div class="row gap-3 justify-content-center">
                    ...
                    <div class="col-sm-12 d-flex justify-content-center">
                        <div class="mt-3">
                            <a href="{{ route('customers.customer-financial.customer-my-payments') }}" class="btn btn-outline-warning mb-4 me-3">Cancel</a>
                            <button type="submit" class="btn btn-outline-primary mb-4">Adiciomar Comprovante</button>
                        </div>
                    </div>
