                    ...
                    <div class="table-responsive">
                        ...
                        <div class="bg-dark w-100 d-flex justify-content-end">
                            ...
                            <div class="d-flex justify-content-start">
                                <div class="">
                                    <a href="{{ route('home', ['id' => $client->id]) }}" class="btn btn-success me-2">home</a>
                                </div>
                            </div>
                            ...
                            <div class="p-3">
                                    <a href="{{ route('customers.customer-dealer.customers.report-view-order-cart-shopping', ['id' => $client->id]) }}" class="btn btn-success me-2" target="_blank" rel="noopener noreferrer">Fatura para Pagamento</a>
                            </div>
