                    ...
                    <div class="table-responsive">
                        <table class="table table-hover {{ $conf['bg_color_table'] }} {{ $conf['color_table_text'] }} w-100">
                            ...
                            <tbody>
                                    ...
                                    @if ($client->user_id == Auth::user()->leader_id)
                                    <tr>
                        ...
                        <div class="bg-dark w-100 d-flex justify-content-end">
                            ...
                            <div class="d-flex justify-content-start">
                                <div class="pt-2">
                                    <a href="{{ route('customers.customer-financial.customer-my-payments', ['id' => $client->id]) }}" class="btn btn-outline-warning me-2">Voltar</a>
                                </div>
                            </div>
                            ...
                            <div class="p-3">
                                    <a href="{{ route('customers.customer-financial.customer-report-view-qr-pix-my-payments', ['id' => $client->id]) }}" class="btn btn-success me-2" target="_blank" rel="noopener noreferrer">Confirma Pagamento</a>
                            </div>
