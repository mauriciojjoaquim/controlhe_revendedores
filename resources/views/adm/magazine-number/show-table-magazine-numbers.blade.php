            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1 row-cols-xl-1 row-cols-xxl-1">
                    <div class="col d-flex justify-content-center">
                        <div class="mb-3">
                            <form action="{{ route('adm.magazine-numbers.show-table-magazine-numbers') }}" method="get">
                                @csrf
                                <div class="container-fluid">
                                            ...
                                            <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 pt-2 mt-1">
                                                <div class="mb-3">
                                                    <div class="d-flex justify-content-start">
                                                        ...
                                                        <div class="mb-2 pt-4">
                                                            <a href="{{ route('adm.magazine-numbers.show-table-magazine-numbers') }}" class="btn btn-sm btn-outline-primary p-2">
                                            ...
                                            <div class="border {{ $conf['color-border'] }} p-2 m-2">
                                                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1 row-cols-xl-1 row-cols-xxl-1">
                                                    ...
                                                    <div class="col text-center mt-1">
                                                        <h4>Inicio: {{ $magazineNumber->start_day }}/{{ $magazineNumber->start_month }}</h4>
                                                    </div>

                                                    <div class="col text-center mt-1">
                                                        <h4>Fim: {{ $magazineNumber->end_day }}/{{ $magazineNumber->end_month }}</h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
