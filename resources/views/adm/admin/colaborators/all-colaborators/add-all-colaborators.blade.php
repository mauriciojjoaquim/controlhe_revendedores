<x-layout-app page-title="New RH User" color-site-bg="{{ $conf['color_site_bg'] }}" bg-color-table="{{ $conf['bg_color_table'] }}" color-table-text="{{ $conf['color_table_text'] }}" color-card-bg="{{ $conf['color_card_bg'] }}" color-card-text="{{ $conf['color_card_text'] }}" bg-color-menu-vert="{{ $conf['bg_color_menu_vertical'] }}" color-menu-vert-text="{{ $conf['color_menu_vertical_text'] }}" bg-color-menu-hor="{{ $conf['bg_color_menu_horisontal'] }}" color-menu-hor-text="{{ $conf['color_menu_horisontal_text'] }}"  text-color-site="{{ $conf['text_color_site'] }}" op-bg-color-site="{{ $conf['bg_color_site'] }}">
    ...
    <div class="w-100 p-2">
        ...
        <form action="{{ route('adm.all-colaborators.created-all-colaborators') }}" method="post">
            ...
            <div class="container-fluid">
                ...
                <div class="justify-content-center">
                    <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-xl-2 g-2 p-2">
                        ...
                        <div class="col-sm-12 col-md-12 cols-xl-12">
                            <div class="border {{ $conf['color-border'] }} p-4 h-100">
                ...
                <div class="d-flex justify-content-center">
                    <div class="mt-3">
                        <div class="d-flex justify-content-center">
                            <a href="{{ route('adm.all-colaborators.table-all-colaborators') }}" class="btn btn-outline-warning me-3 mb-4">Cancel</a>
