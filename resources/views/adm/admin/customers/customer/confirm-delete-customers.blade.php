    ...
    <div class="w-100 p-4">
        ...
        <div class="text-center">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('adm.customers.customer.table-customers') }}" class="btn btn-warning px-5">No</a>
            <form action="{{ route('adm.customers.customer.deleted-customers') }}" method="post" class="px-2">
                @csrf
