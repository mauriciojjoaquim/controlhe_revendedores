<x-layout-app page-title="Edit Setting" color-site-bg="{{ $conf['color_site_bg'] }}" bg-color-table="{{ $conf['bg_color_table'] }}" color-table-text="{{ $conf['color_table_text'] }}" color-card-bg="{{ $conf['color_card_bg'] }}" color-card-text="{{ $conf['color_card_text'] }}" bg-color-menu-vert="{{ $conf['bg_color_menu_vertical'] }}" color-menu-vert-text="{{ $conf['color_menu_vertical_text'] }}" bg-color-menu-hor="{{ $conf['bg_color_menu_horisontal'] }}" color-menu-hor-text="{{ $conf['color_menu_horisontal_text'] }}"  text-color-site="{{ $conf['text_color_site'] }}" op-bg-color-site="{{ $conf['bg_color_site'] }}">
    ...
    <div class="w-100 p-2">
        ...
        <hr>
        {{-- disabled --}}
        <form action="{{ route('adm.settings.updated-settings') }}" method="post">
                ...
                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1 row-cols-xl-1 row-cols-xxl-1 d-flex justify-content-center">
                            ...
                            <div class="border {{ $conf['color-border'] }} p-2">
                                ...
                                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1 row-cols-xl-2 row-cols-xxl-2">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                        ...
                                        <span class="border-bottom {{ $conf['color-border'] }} w-100"></span>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                                        <div class="mb-3">
                                            <label for="user_id" class="form-label">Nome do Usuária</label>
                                                ...
                                                @if (old('user_id', $setting->user_id) == $user->id)
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                                        <div class="mb-3">
                                            <label for="price" class="form-label">Preço Minimo para parcela</label>
                                    ...
                                    <div class="mt-3 col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                        <h3>Dados do Site do Cliente</h3>
                                    ...
                                    <div class="mt-3 col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                        <h3>Dados do Site do administrador</h3>
                                        <span class="border-bottom  w-100"></span>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="text_color_site" class="form-label">Cor do texto do site</label>
                                                ...
                                                @foreach ($boots as $item)
                                                    @if (old('color_table_text',$setting->color_table_text) == $item->color_text)
                                        ...
                                        <div class="mb-3">
                                            <label for="cor_id" class="form-label">Cor da tabela</label>
                                                <select class="form-select" name="bg_color_table" aria-label="Floating label select example">
                                                    ...
                                                    @foreach ($boots as $item)
                                                        @if (old('bg_color_table', $setting->bg_color_table) == $item->color_table_bg)
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                                        <div class="mb-3">
                                            <label for="color_card_bg" class="form-label">Cor do card</label>
                                                ...
                                                @foreach ($boots as $item)
                                                @if (old('color_card_bg', $setting->color_card_bg) == $item->color_card_bg)
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                                        <div class="mb-3">
                                            <label for="color_card_text" class="form-label">Cor do texto do card</label>
                                                ...
                                                @foreach ($boots as $item)
                                                @if (old('color_card_text', $setting->color_card_text) == $item->color_text)
                                                    <option class="{{ $item->color_text }}" value="{{ $item->color_text }}" selected>{{ $item->name }}</option>
                                                @else
                                                    <option class="{{ $item->color_text }}" value="{{ $item->color_text }}">{{ $item->name }}</option>
                                                @endif
                                    ...
                                    {{-- bg color menu vertical --}}
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                                        <div class="mb-3">
                                            <label for="bg_color_menu" class="form-label">Cor do Menu Vertical</label>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                                        <div class="mb-3">
                                            <label for="color_menu_vertical_text" class="form-label">Cor do texto do menu Vertical</label>
                                                ...
                                                @foreach ($boots as $item)
                                                    @if (old('color_menu_vertical_text', $setting->color_menu_vertical_text) == $item->color_text)
                                                    <option class="{{ $item->color_text }}" value="{{ $item->color_text }}" selected>{{ $item->name }}</option>
                                                    @else
                                                    <option class="{{ $item->color_text }}" value="{{ $item->color_text }}">{{ $item->name }}</option>
                                                @endif
                                    ...
                                    {{-- bg color menu horisontal --}}
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                                        <div class="mb-3">
                                            <label for="bg_color_menu" class="form-label">Cor do Menu Horisontal</label>
                                    ...
                                    {{-- color menu horisontal text --}}
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                                        <div class="mb-3">
                                            <label for="color_menu_vertical_text" class="form-label">Cor do texto do menu Horisontal</label>
                                                <select class="form-select" name="color_menu_horisontal_text" aria-label="Floating label select example">
                                                <option value="">Selecione uma cor para texto do menu</option>
                                                @foreach ($boots as $item)
                                                    @if (old('color_menu_horisontal_text', $setting->color_menu_horisontal_text) == $item->color_text)
                                                    <option class="{{ $item->color_text }}" value="{{ $item->color_text }}" selected>{{ $item->name }}</option>
                                                    @else
                                                    <option class="{{ $item->color_text }}" value="{{ $item->color_text }}">{{ $item->name }}</option>
                                                @endif
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                        ...
                        <div class="mt-3 d-flex justify-content-center">
                            <a href="{{ route('adm.settings.table-settings') }}" class="btn btn-outline-warning me-3">Voltar</a>
