<x-layout-app page-title="Delete Setting" color-site-bg="{{ $conf['color_site_bg'] }}" bg-color-table="{{ $conf['bg_color_table'] }}" color-table-text="{{ $conf['color_table_text'] }}" color-card-bg="{{ $conf['color_card_bg'] }}" color-card-text="{{ $conf['color_card_text'] }}" bg-color-menu-vert="{{ $conf['bg_color_menu_vertical'] }}" color-menu-vert-text="{{ $conf['color_menu_vertical_text'] }}" bg-color-menu-hor="{{ $conf['bg_color_menu_horisontal'] }}" color-menu-hor-text="{{ $conf['color_menu_horisontal_text'] }}"  text-color-site="{{ $conf['text_color_site'] }}" op-bg-color-site="{{ $conf['bg_color_site'] }}">
            ...
            <div class="col-xl-12 col-md-12 col-md-12 col-sm-12">
                <div class="text-center">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('adm.settings.table-settings') }}" class="btn btn-warning px-5">No</a>
                    <form action="{{ route('adm.settings.deleted-settings') }}" method="post" class="px-2">
                        @csrf
