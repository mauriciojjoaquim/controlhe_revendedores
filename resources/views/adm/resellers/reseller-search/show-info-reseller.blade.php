        ...
        <div class="container-fluid">
            <div class="justify-content-center">
                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-xl-2 g-2 p-1">
                    ...
                    <div class="col">
                        <a href="{{ route('admin.dealers.clients.client.table-resellers') }}" class="btn btn-outline-dark"><i class="fas fa-arrow-left me-2"></i>Voltar</a>
                    </div>
                </div>
            </div>
            <div class="w-100">
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-1 justify-content-end">
                                                                ...
                                                                <div class="btn-lg-display d-flex gap-1 justify-content-end">
                                                                    <a href="{{ route('adm.resellers.reseller-search.detail.show-order-resellers', ['id' => $client->id])  }}" class="btn btn-sm btn-outline-warning ms-2"><i class="fas fa-eye me-2"></i>Detalhe</a>
                                                                <a href="{{ route('admin.dealers.clients.client.edit-resellers', ['id' => $client->id]) }}" class="btn btn-sm btn-outline-primary ms-2"><i class="fa-regular fa-pen-to-square me-2"></i>Editar</a>
                                                                <a href="{{ route('admin.dealers.clients.client.conf-delete-resellers', ['id' => $client->id]) }}" class="btn btn-sm btn-outline-danger ms-2"><i class="fa-regular fa-trash-can me-2"></i>Excluir</a>
                                                                ...
                                                                <div class="btn-group btn-sm-display" role="group" aria-label="action">
                                                                    ...
                                                                    <ul class="dropdown-menu " aria-labelledby="btnGroupDrop1">
                                                                        <li><a href="{{ route('adm.resellers.reseller-search.detail.show-order-resellers', ['id' => $client->id]) }}" class="dropdown-item"><i class="fas fa-eye me-2"></i>Detalhe</a></li>
                                                                        <li><a href="{{ route('admin.dealers.clients.client.edit-resellers', ['id' => $client->id]) }}" class="dropdown-item"><i class="fa-regular fa-pen-to-square me-2"></i>Editar</a></li>
                                                                        <li><a href="{{ route('admin.dealers.clients.client.conf-delete-resellers', ['id' => $client->id]) }}" class="dropdown-item"><i class="fa-regular fa-trash-can me-2"></i>Excluir</a></li>
                                                                    </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
