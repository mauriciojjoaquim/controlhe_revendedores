<x-layout-app page-title="Novo boleto" color-site-bg="{{ $conf['color_site_bg'] }}" bg-color-table="{{ $conf['bg_color_table'] }}" color-table-text="{{ $conf['color_table_text'] }}" color-card-bg="{{ $conf['color_card_bg'] }}" color-card-text="{{ $conf['color_card_text'] }}" bg-color-menu-vert="{{ $conf['bg_color_menu_vertical'] }}" color-menu-vert-text="{{ $conf['color_menu_vertical_text'] }}" bg-color-menu-hor="{{ $conf['bg_color_menu_horisontal'] }}" color-menu-hor-text="{{ $conf['color_menu_horisontal_text'] }}"  text-color-site="{{ $conf['text_color_site'] }}" op-bg-color-site="{{ $conf['bg_color_site'] }}">
    ...
    <div class="w-100 p-2">
        ...
        <hr>
        {{-- disabled --}}
        <form action="{{ route('adm.resellers.reseller-invoice-registration-for-payments.created-reseller-invoice') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="container-fluid">
                                    ...
                                    <div class="row cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1">
                                            ...
                                            <div class="row cols-2 row-cols-sm-1 row-cols-md-2 row-cols-lg-2">
                                                ...
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" id="installment_number" name="installment_number" value="{{ old('installment_number') }}">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="pix_invoice_number" name="pix_invoice_number" value="{{ old('pix_invoice_number') }}">
                ...
                <div class="mt-3 d-flex justify-content-center">
                    ...
                    <button type="submit" class="btn btn-outline-primary">Novo Boleto</button>
                </div>
