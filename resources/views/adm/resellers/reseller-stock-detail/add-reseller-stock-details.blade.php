            ...
            <form action="{{ route('adm.resellers.reseller-stock-detail.created-reseller-stock-details') }}" method="post"  enctype="multipart/form-data">
                ...
                <div class="container-fluid">
                    <div class="border {{ $conf['color-border'] }} p-2">
                        <div class="row row-cols-1 row-cols-sm-1 row-cols-md-3 row-cols-lg-6 row-cols-xl-6 row-cols-xxl-6">
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    <label for="amont" class="form-label">Quant.</label>
                    ...
                    <tbody>
                        @foreach ($products as $product)
                                ...
                                <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('adm.resellers.reseller-stock-detail.created-table-reseller-stock-details') }}" method="post"  enctype="multipart/form-data">
                                                    @csrf
