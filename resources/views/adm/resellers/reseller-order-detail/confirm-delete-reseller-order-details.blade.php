    ...
    <div class="w-100 p-4">
        ...
        <div class="text-center">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('admin.clients.client-order-detail.table-client-order-detail') }}" class="btn btn-warning px-5">No</a>
            <form action="{{ route('admin.clients.client-order-detail.deleted-client-order-detail') }}" method="post" class="px-2">
                @csrf
