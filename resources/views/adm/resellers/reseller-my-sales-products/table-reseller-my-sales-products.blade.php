<x-layout-app page-title="Todo Pedido de Produto" color-site-bg="{{ $conf['color_site_bg'] }}" bg-color-table="{{ $conf['bg_color_table'] }}" color-table-text="{{ $conf['color_table_text'] }}" color-card-bg="{{ $conf['color_card_bg'] }}" color-card-text="{{ $conf['color_card_text'] }}" bg-color-menu-vert="{{ $conf['bg_color_menu_vertical'] }}" color-menu-vert-text="{{ $conf['color_menu_vertical_text'] }}" bg-color-menu-hor="{{ $conf['bg_color_menu_horisontal'] }}" color-menu-hor-text="{{ $conf['color_menu_horisontal_text'] }}"  text-color-site="{{ $conf['text_color_site'] }}" op-bg-color-site="{{ $conf['bg_color_site'] }}">
...
<a href="{{ route('adm.resellers.reseller-my-sales-products.reload-reseller-my-sales-products') }}" class="btn btn-sm btn-outline-primary ms-2 p-2">
            ...
            <div class="border {{ $conf['color-border'] }} shadow mb-3">
                <div class="card-header {{ $conf['color_card_bg'] }} {{ $conf['color_card_text'] }} p-2">
                    <form action="{{ route('adm.resellers.reseller-my-sales-products.table-reseller-my-sales-products') }}" method="get">
                        <div class="d-flex justify-content-between">
                            <div class="row w-100">
                                ...
                                <div class="col-sm-5 col-md-2 mt-2 d-flex justify-content-end pt-4">
                                    ...
                                    <a href="{{ route('adm.resellers.reseller-my-sales-products.table-reseller-my-sales-products') }}" class="btn btn-sm btn-outline-primary ms-2 pt-3">
                ...
                <div class="mb-3 d-flex justify-content-end p-1">
                    <a href="{{ url('adm/resellers/reseller-my-sales-products/relatorio-reseller-my-sales-products?' . request()->getQueryString()) }}" class="btn btn-sm btn-outline-primary ms-2"><i class="fa-regular fa-file-lines me-2"></i>Gerar PDF</a>
                    <a href="{{ url('adm/resellers/reseller-my-sales-products/completeo-rder-reseller-my-sales-products?' . request()->getQueryString()) }}" class="btn btn-sm btn-outline-danger ms-2"><i class="fa-regular fa-file-lines me-2"></i>Finalizar Pedido</a>
