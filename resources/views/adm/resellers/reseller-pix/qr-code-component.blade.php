            ...
            <div class="col-xl-10 col-md-10 col-md-12 col-sm-12">
                <div class="justify-content-end w-100">
                    <div class="table-responsive">
                        <table class="table table-bordered {{ $conf['bg_color_table'] }} {{ $conf['color_table_text'] }}">
                        ...
                        <div class="bg-dark w-100 d-flex justify-content-end">
                            <div class="p-3 text-success h3 text-start">
                                <a href="{{ route('home') }}" class="btn btn-success me-2">Home</a>
                            </div>
                            ...
                            <div class="p-3">
                                @can('vende')
                                    <a target="_blank" href="{{ route('adm.resellers.reseller-my-sales-products.report-view-order-cart-shopping', ['id' => $client->id]) }}" class="btn btn-success me-2">Gera Fatura de Pagamento</a>
                                @endcan
                                @can('client')
                                    <a href="{{ route('admin.dealers.clients.client.client-confirma-cart-payment-detail', ['id' => $client->id]) }}" class="btn btn-success me-2">Gera Fatura de Pagamento</a>
                                @endcan
                            </div>
...
{{-- adm/resellers/reseller-my-sales-products/report-order-cart-shopping --}}