    ...
    <div class="w-25 p-4">
        ...
        <div class="text-center">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('colaborators.colaborator.colaborators') }}" class="btn btn-warning px-5">No</a>
            <form action="{{ route('colaborators.colaborator.delete-colaborator') }}" method="post" class="px-2">
                @csrf
