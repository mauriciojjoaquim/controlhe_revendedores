        ...
        <div class="container-fluid">
            <div class="row mb-3">
                ...
                <div class="col">
                    ...
                    <p>Number: <strong>{{ $colaborator->detail->number }}</strong></p>
                    <p>Complement: <strong>{{ $colaborator->detail->complement }}</strong></p>
                    <p>Neighborhood: <strong>{{ $colaborator->detail->neighborhood }}</strong></p>
