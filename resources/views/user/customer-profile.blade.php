        ...
        <div class="container-fluid m-0 p-0 mt-5">
            <div class="row row-cols row-cols-sm-1 row-cols-lg-2 row-cols-xl-3 row-cols-xxl-4  gap-3">
                    ...
                    <div class="col-12">
                        ...
                        <x-customers.profile-customer-change-password />
                    </div>
                    </div>
                    {{-- autera nome e email --}}
                    <div class="col-12">
                        <div class="border {{ $conf['color-border'] }} p-2">
                        <x-customers.profile-customer-change-data :colaborator="$colaborator" />
                        </div>
                    </div>
                    {{-- autera Detail --}}
                    <div class="col-12">
                        <div class="border {{ $conf['color-border'] }} p-2">
                        <x-customers.profile-customer-change-detail :colaborator="$colaborator->detail" />
                        </div>
                    </div>
