<x-layout-app page-title="Novo Produto" color-site-bg="{{ $conf['color_site_bg'] }}" bg-color-table="{{ $conf['bg_color_table'] }}" color-table-text="{{ $conf['color_table_text'] }}" color-card-bg="{{ $conf['color_card_bg'] }}" color-card-text="{{ $conf['color_card_text'] }}" bg-color-menu-vert="{{ $conf['bg_color_menu_vertical'] }}" color-menu-vert-text="{{ $conf['color_menu_vertical_text'] }}" bg-color-menu-hor="{{ $conf['bg_color_menu_horisontal'] }}" color-menu-hor-text="{{ $conf['color_menu_horisontal_text'] }}"  text-color-site="{{ $conf['text_color_site'] }}" op-bg-color-site="{{ $conf['bg_color_site'] }}">
    ...
    <div class="w-100 p-1">
        ...
        <form action="{{ route('admin.dealers.client-products.created-client-product') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-xl-1 p-2">
                        ...
                        <div class="col-xl-12 col-md-12 col-md-12 col-sm-12">
                            <div class="border {{ $conf['color-border'] }} p-4">
                                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-xl-2">
                                    ...
                                    <div class="col-xl-9 col-md-9 col-md-12 col-sm-12">
                                        <div class="mb-3">
                        ...
                        <div class="col-xl-12 col-md-12 col-md-12 col-sm-12">
                            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-xl-2">
                                ...
                                <div class="col-xl-6 col-md-6 col-md-12 col-sm-12">
                                    <div class="mb-3">
                                        <label for="name" class="form-label">Porcentagem</label>
                                        ...
                                        <div class="row">
                                            <div class="col12 pe-3">
                                                ...
                                                <select class="form-select" id="category_id" name="category_id">
                                                    <option value="0" selected>Selecione um Categoria</option>
                                ...
                                <div class="col-xl-6 col-md-6 col-md-12 col-sm-12"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-xl-2 p-2">
                    <div class="col-xl-12 col-md-12 col-md-12 col-sm-12">
                        <div class="d-flex justify-content-center">
                            ...
                            <div class="mt-3">
                                <a href="{{ route('admin.dealers.client-products.table-client-product') }}" class="btn btn-outline-warning me-3">Voltar</a>
                            </div>
                            <div class="mt-3">

                                <button type="submit" class="btn btn-outline-primary mb-4">Criar Produto</button>
                            </div>
                        </div>
