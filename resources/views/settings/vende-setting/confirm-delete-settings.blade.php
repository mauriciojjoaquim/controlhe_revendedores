            ...
            <div class="col-xl-12 col-md-12 col-md-12 col-sm-12">
                <div class="text-center">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('adm.settings-resellers.table-vende-settings') }}" class="btn btn-warning px-5">No</a>
                    <form action="{{ route('adm.settings-resellers.deleted-vende-settings') }}" method="post" class="px-2">
                        @csrf
