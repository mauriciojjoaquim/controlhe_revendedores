...
class ResellerProductController extends Controller
{
    ...
    public function tableProduct(): View
    {
        ...
        return view('adm.resellers.reseller-products.table-reseller-products', compact('conf', 'products'));
    ...
    public function addProduct(): View
    {
        ...
        return view('adm.resellers.reseller-products.add-reseller-products', compact('conf', 'suppliers', 'categories'));
    }
    ...
    public function editProduct($id): View
    {
        ...
        return view('adm.resellers.reseller-products.edit-reseller-products', compact('conf', 'product', 'suppliers','categories'));
    ...
    $product->save();
        ...
        return redirect()->route('admin.dealers.client-products.table-client-product')
                                ->with([
                                    'status' => true ,
                                    'tipo_alert' => 'success',
    ...
    public function showProduct($id): View
    {
        ...
        return view('dealers.client-products.show-client-products', compact('conf', 'product'));
    }
    ...
    public function confDeleteProduct($id): View
    {
        ...
        return view('adm.resellers.reseller-products.confirm-delete-reseller-products',compact('cnfo', 'product'));
    }
