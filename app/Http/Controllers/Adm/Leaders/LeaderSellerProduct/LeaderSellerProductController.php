...
namespace App\Http\Controllers\Adm\Leaders\LeaderSellerProduct;
...
class LeaderSellerProductController extends Controller
{
    //Product Table
    public function tableLeaderProduct(): View
    {
        ...
        return view('adm.leaders.leader-seller-product.table-leader-seller-products', compact('products', 'conf'));

    }

    //Product New
    public function addLeaderProduct(): View
    {
    ...
    //Product Edit
    public function editLeaderProduct($id): View
    {
    ...
    //Product Created
    public function createdLeaderProduct(Request $request)
    {
        ...
        return redirect()->route('adm.Leaders.leader-seller-product.table-leader-seller-product')->with([
            'status' => true ,
            'tipo_alert' => 'success',
    ...
    //Product Updated
    public function updatedLeaderProduct(Request $request)
    {
    ...
    //Product Show
    public function showLeaderProduct($id): View
    {
    ...
    public function confDeleteLeaderProduct($id): View
    {
    ...
    //Product Delete
    public function deletedLeaderProduct(Request $request)
    {
        ...
        return redirect()->route('adm.Leaders.leader-seller-product.table-leader-seller-product')
                        ->with([
                                    'status' => true ,
                                    'tipo_alert' => 'success',
